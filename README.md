...
# Requisitos
Para ejecutar el notebook, necesitarás las siguientes bibliotecas de Python:
...
Abre y ejecuta el notebook Titanic-Modelo.ipynb para ver el análisis y los resultados del modelo.
